...
#define configUSE_TICKLESS_IDLE                         0                       /* 改用 idle hook + WFI */
...
#define configTOTAL_HEAP_SIZE                           ((size_t)(25 * 1024))   /* OTA队列~8.2KB + 任务栈~12KB + 其他 */
...
/* 钩子函数相关定义 */
#define configUSE_IDLE_HOOK                             1                       /* 空闲时调 vApplicationIdleHook → WFI */
